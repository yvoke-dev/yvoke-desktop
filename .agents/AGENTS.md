...
- **Mandatory ASDD for ALL tasks**: Always use the ASDD workflow for ALL tasks, including small / follow-up changes. No feature, refactor, behavior, or styling change may bypass ASDD phases or adversarial gates. Activate the `asdd` skill (`.agents/skills/asdd/SKILL.md`) or follow `.antigravity/sdd_protocol.md`.
